...
function AllCategories1() {
  ...
  const fetchItems = async () => {
    try {
      const response = await fetch("https://foodie-final1-iof5.vercel.app/?vercelToolbarCode=oeLNhUdMyi_kX5o/api/add-new/items");
    ...
    setTimeout(async () => {
      try {
        const response = await fetch(
          `https://foodie-final1-iof5.vercel.app/?vercelToolbarCode=oeLNhUdMyi_kX5o/api/add-new/items/${id}`,
          {
            method: "DELETE",
          }
        );
